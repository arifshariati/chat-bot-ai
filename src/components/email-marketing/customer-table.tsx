          ...
          <TableRow key={c.id}>
            <TableCell>
              <Card
                ...
                className={cn("rounded-full w-5 h-5 border-4 cursor-pointer", select.includes(c.email as string) ? "bg-orange" : "bg-peach")}
              />
            </TableCell>
            ...
            <TableCell>
              <SideSheet
                ...
                trigger={
                  <Card className="bg-grandis py-2 px-4 cursor-pointer text-gray-700 hover:bg-orange" onClick={() => onId(c.id)}>
                    View
                  </Card>
                }
              >
