...
const EmailMarketing = ({ campaign, domains, subscription }: EmailMarketingProps) => {
  const {
    onSelectedEmails,
    isSelected,
    onCreateCampaign,
        ...
        <div className="flex gap-3 justify-end">
          ...
          >
            <form className="flex flex-col gap-4" onSubmit={onCreateCampaign}>
              <FormGenerator name="name" register={register} errors={errors} inputType="input" placeholder="your campaign name" type="text" />
