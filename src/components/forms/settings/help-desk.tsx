"use client";
import { useHelpDesk } from "@/hooks/useSettings";
...
const HelpDesk = ({ id }: HelpDeskProps) => {
    ...
    <Card className="w-full grid grid-cols-1 lg:grid-cols-2">
      ...
      <CardContent className="p-6 overflow-y-auto chat-window">
        <Loader loading={loading}>
          {isQuestions.length ? (
            isQuestions.map((question) => <Accordion key={question.id} trigger={question.question} content={question.answer} />)
          ) : (
