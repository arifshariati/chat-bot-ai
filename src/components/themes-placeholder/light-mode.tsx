  ...
  return (
    <svg width="282" height="193" viewBox="0 0 282 193" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        fill="#F5F5F5"
      />
      <path d="M28 42C28 33.7157 34.7157 27 43 27H242C250.284 27 257 33.7157 257 42V193H28V42Z" fill="white" />
      ...
      <rect x="44" y="110" width="61" height="17" rx="3" fill="#D9D9D9" />
      <rect x="44" y="132" width="61" height="17" rx="3" fill="#D9D9D9" />
      <path d="M137 27H242C250.284 27 257 33.7157 257 42V193H137V27Z" fill="white" />
      <path d="M137 67H238C241.314 67 244 69.6863 244 73V188C244 190.761 241.761 193 239 193H137V67Z" fill="#D9D9D9" />
