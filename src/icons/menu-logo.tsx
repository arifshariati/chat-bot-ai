...
export const MenuLogo = ({ onClick }: MenuLogoProps) => {
  return (
    <svg onClick={onClick} width="30" height="30" viewBox="0 0 110 110" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill="#FFC90C"
      />
      <rect y="27.3125" width="109.25" height="81.9375" rx="3.375" fill="#FFA947" />
      <path d="M38.2375 38.2375C44.1966 50.2938 62.0739 55.1163 71.0126 38.2375" stroke="white" strokeWidth="1.125" strokeLinecap="round" />
    </svg>
  );
};
